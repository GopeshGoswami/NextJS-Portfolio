    ...
    <section>
      <div>
        ...
        <p className=" text-md py-2 leading-8 text-gray-800 dark:text-white">
          ...
          learning <span className=" text-teal-500">Front-End Development</span>{" "}
          as my fortie for quite some time along with DSA. I'm quite confident,
      ...
      <div className=" lg:flex gap-10">
        ...
        <div className=" text-center shadow-lg p-10 rounded-xl my-10 dark:shadow-sm dark:bg-gray-900">
          ...
          <p className=" text-gray-800 py-1 dark:text-white">JS</p>
          <p className=" text-gray-800 py-1 dark:text-white">CSS/TailwindCSS</p>
